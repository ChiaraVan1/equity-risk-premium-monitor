"""
dividend_yield_fetch.py
──────────────────────────────────────────────────────────────────────────────
指数股息率数据获取模块（原 dividend_yield.py 拆分出的"数据获取"部分）
支持 A股（理杏仁）+ 境外/港股（yfinance）双数据源
...
"搬家"，函数体没有任何改动。分析/报告生成部分见 dividend_yield_analysis.py。
──────────────────────────────────────────────────────────────────────────────
"""
